 ...
 * Redefinition is different from overloading because the
 * redefined function has the same name and parameter list as
 * the original function.
 * Objects of the base class use the base version, and objects
 * of the derived class use the derived version.
 */
